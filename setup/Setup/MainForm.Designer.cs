...
namespace Terraria.ModLoader.Setup
{
    partial class MainForm
    {
        ...
        private void InitializeComponent() {
			...
			this.toolTipButtons.SetToolTip(this.buttonSetup, "Complete environment setup for working on BetterWorkshop source\r\nEquivalent to Decomp" +
		"ile+Patch+SetupDebug\r\nEdit the source in src/BetterWorkshop then run Diff BetterWorkshop" +
        ...
        "source is located in src/Terraria");
			...
			this.buttonPatchModLoader.Text = "Patch BetterWorkshop";
			this.toolTipButtons.SetToolTip(this.buttonPatchModLoader, "Applies BetterWorkshop patches to Terraria\r\nEdit the source code in src/BetterWorkshop af" +
        "ter this phase\r\nInternally formats the Terraria sources before patching");
			...
			this.buttonDiffModLoader.Text = "Diff BetterWorkshop";
        ...
        "t to Setup without Decompile");
			...
			this.buttonSetupDebugging.Text = "Debugging (Disabled)";
			...
			this.buttonSetupDebugging.Enabled = false;
			// 
			// MainForm
			// 
			...
			this.Name = "MainForm";
			this.Text = "BetterWorkshop Dev Setup";
